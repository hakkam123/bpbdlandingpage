      ...
      <div className="flex w-full h-screen">
        ...
        <div className="w-1/2 p-8 flex flex-col justify-center bg-white">
            <div className="m-9">          
              ...
              <h2 className="text-black text-xl font-semibold">Silahkan Login</h2>
              <p className="text-gray-600 mb-12">
                Belum Punya Akun? <a className="text-red-600" href="/auth/register">Register</a>
              </p>
              ...
              <form>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center">
                      ...
                      <label className="text-gray-700 text-sm" htmlFor="remember">Remember me</label>
                    </div>
                    <a className="text-blue-600 text-sm" href="#">Lupa Kata Sandi?</a>
                  </div>
